...
public class FormMeetingStep extends Step<String> {
    ...
    public FormMeetingStep(String title) {
        this(title, "");
    }

    public FormMeetingStep(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        membersEditText.setHint(R.string.rencontre);
