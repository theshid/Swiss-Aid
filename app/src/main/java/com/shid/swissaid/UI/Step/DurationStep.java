...
public class DurationStep extends Step<String> {
    ...
    public DurationStep(String title) {
        this(title, "");
    }

    public DurationStep(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        fileEditText.setHint(R.string.duree_projet);
