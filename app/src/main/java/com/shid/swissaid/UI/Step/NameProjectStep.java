...
public class NameProjectStep extends Step<String> {
    ...
    public NameProjectStep(String title) {
        this(title, "");
    }

    public NameProjectStep(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        fileEditText.setHint(R.string.nom_projet);
