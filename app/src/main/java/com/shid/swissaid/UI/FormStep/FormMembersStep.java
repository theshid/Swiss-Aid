...
public class FormMembersStep extends Step<String> {
    ...
    public FormMembersStep(String title) {
        this(title, "");
    }

    public FormMembersStep(String title, String subtitle) {
    ...
    protected View createStepContentLayout() {
        ...
        membersEditText.setHint(R.string.membre);
